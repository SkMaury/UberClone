        ...
        location_switch.setOnCheckedChangeListener(new MaterialAnimatedSwitch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(boolean isOnline) {
                if(isOnline) {
                    startLocationUpdate();
                    displayLocation();
                    Snackbar.make(mapFragment.getView(), getString(R.string.now_online), Snackbar.LENGTH_SHORT).show();
                }
                else{
                    stopLocationUpdates();
                    mCurrent.remove();
                    Snackbar.make(mapFragment.getView(), getString(R.string.now_offline), Snackbar.LENGTH_SHORT).show();
                }

            }
        });

        /* Geo Fire related code */
    ...
    private boolean checkPlayServices() {
        ...
        if(resultCode != ConnectionResult.SUCCESS){
            if(googleApiAvailability.isUserResolvableError(resultCode))
                ...
                Toast.makeText(this, R.string.play_service_device_not_supported, Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
        ...
        fusedLocationProviderClient.getLastLocation()
                .addOnSuccessListener(new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        /* GPS location can be null if GPS is off */
                        if(location != null)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Welcome.this, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                });
